                                        ...
                                        <a data-action="collapse">
                                            ...
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li><a data-action="collapse"><i class="ft-maximize"></i></a></li>
                                                </ul>
                                            </div>
                                        </a>
                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="price" name="price"
                                                                class="form-control" placeholder="example price 1000000"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a class="heading-elements-toggle"><i class="la la-ellipsis-v f font-medium-3"></i></a>
                                        <div class="heading-elements">
                                            <ul class="list-inline mb-0">
                                                    ...
                                                    <tbody>
                                                        @forelse ($specialist as $key => $specialist_item)
                                                            <tr data-entry-id="{{ $specialist_item->id }}">
                                                                <td>{{ isset($specialist_item->updated_at) ? date('d/m/Y H:i:s', strtotime($specialist_item->updated_at)) : '' }}
                                                                </td>
                                                                            ...
                                                                            @can('specialist_delete')
                                                                                <form
                                                                                    ...
                                                                                    <input type="submit"
                                                                                        ...
                                                                                        value="Delete"
                                                                                        data-name="{{ $specialist_item->name }}">
                                                                                </form>
                                                                            @endcan
                                                                        </div>
                                                                    </div>
