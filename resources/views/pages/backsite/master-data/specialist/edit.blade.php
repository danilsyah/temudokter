                                        ...
                                        <form method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="name" class="col-md-3 label-control">Name <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            class="form-control" placeholder="please input specialist name"
                                                ...
                                                <div class="form-group row">
                                                    <label for="price" class="col-md-3 label-control">Price <code
                                                            style="color: red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="price" name="price"
                                                            class="form-control" placeholder="example 100000"
                                            ...
                                            <div class="form-actions text-right">
                                                ...
                                                <button type="submit" style="width:120px;"
                                                    class="btn btn-cyan update_confirm">
